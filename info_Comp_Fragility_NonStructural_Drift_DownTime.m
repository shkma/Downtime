function [PDS_ij_EDP, xm_Cost, numCompPerStory] = info_Comp_Fragility_NonStructural_Drift_DownTime(i_n, i_m, x_PSDR_pdf)
...
% i_m = ID of component
    ...
    % % % % % % % % % % % % % % % %
       ...
       elseif i_n == 1
          ...
          xm_EDP=0.0039; beta_EDP=0.17; xm_Cost=0.042;
       ...
       elseif i_n == 2
          ...
          xm_EDP=0.0085; beta_EDP=0.23; xm_Cost=0.167;
          F_DS_ij    = normcdf((log(x_PSDR_pdf/xm_EDP))/beta_EDP); % compute fragility function using Eq. 1 and estimated parameters
    ...
    % % % % % % % % % % % % % % % %
       ...
       elseif i_n == 2
          ...
          xm_EDP=0.0085; beta_EDP=0.23; xm_Cost=0.292;
          F_DS_ij    = normcdf((log(x_PSDR_pdf/xm_EDP))/beta_EDP); % compute fragility function using Eq. 1 and estimated parameters
          PDS_ij_EDP = F_DS_ij;             % j=n, i.e. biggest damage
    ...
    % % % % % % % % % % % % % % % %
       ...
       elseif i_n == 1
          ...
          xm_EDP=0.04; beta_EDP=0.36; xm_Cost=0.479;
          F_DS_i1    = normcdf((log(x_PSDR_pdf/xm_EDP))/beta_EDP); % compute fragility function using Eq. 1 and estimated parameters
       ...
       elseif i_n == 2
          ...
          xm_EDP=0.046; beta_EDP=0.33; xm_Cost=0.479;
          F_DS_ij    = normcdf((log(x_PSDR_pdf/xm_EDP))/beta_EDP); % compute fragility function using Eq. 1 and estimated parameters
          PDS_ij_EDP = F_DS_ij;             % j=n, i.e. biggest damage
